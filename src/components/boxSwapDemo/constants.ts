...
export const LIFECYCLE_STEPS = [
    { status: 'Storing', listedMode: 'N/A', label: 'Minted' },
    { status: 'Selling', listedMode: 'Selling', label: 'Listed' },
    { status: 'Auctioning', listedMode: 'Auctioning', label: 'Auctioning' }, // Alternative path
    { status: 'Paid', listedMode: 'Selling', label: 'Purchased' },
    { status: 'Delaying', listedMode: 'Selling', label: 'Delaying Reveal' },
    { status: 'Published', listedMode: 'Selling', label: 'Revealed' },
];
