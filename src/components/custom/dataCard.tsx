...
export const DataCard: React.FC<StatCardProps> = ({ label, value, sub, trend, icon: Icon, color = "text-primary", link }) => {
  ...
  const CardContent = () => (
    <div className={`
      ...
      transition-all duration-300 group bg-surface 
      hover:bg-surface-low hover:border hover:border-l-3 hover:border-primary-dim
    `}>
      ...
      <h3 className={`text-3xl font-bold mb-2 group-hover:${textColor} transition-colors`}>{value}</h3>
